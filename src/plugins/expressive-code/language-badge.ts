...
export function pluginLanguageBadge() {
	return definePlugin({
      ...
      [data-language]::before {
        ...
        font-family: 'JetBrainsMonoNerdFont-Light', 'LXGWWenKai-Light', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
        font-size: 0.75rem;
        font-weight: bold;
