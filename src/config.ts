...
export const profileConfig: ProfileConfig = {
	avatar:
		"https://image-hosting-1314508256.cos.ap-shanghai.myqcloud.com/person/avatar.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "特让他也让",
...
export const umamiConfig = {
	...
	shareURL: "https://umami.trtyr.top/share/o0xKoBWzZrIb1uaX/www.trtyr.top", //你的分享API,支持自建服务
	scripts: `
<script defer src="https://umami.trtyr.top/script.js" data-website-id="cc8468e9-30a9-4f4c-bf6d-5083f988cb87"></script>  `.trim(), //上面填你要插入的Script,不用再去Layout中插入
} as const;
